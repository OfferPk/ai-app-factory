...
def get_ai_app():
    ...
    prompt = f"""
    You are an expert full-stack developer. Create a unique, highly polished, beautiful single-page web app in the category: '{chosen_cat}'.
    The app must be completely functional using HTML5, CSS (modern Tailwind or sleek CSS), and vanilla JavaScript.
    ...
    {{
      ...
      "html_code": "<!DOCTYPE html>...full working html/css/js code...",
